...
% tic,
    ...
    [y_est11,y_est21,y_est31] = NLH_Wiener(8,N2,N3,Ns,8,double(imp1),double(imp2),double(imp3),single(gamma),...
                sigma_est_b/255, double(dis_map*255),double(imr1*gamma),double(imr2*gamma),double(imr3*gamma),double(imr2*beta+imp1*(1-beta)));            
     for ii = 1:iter
    [y_est1,y_est2,y_est3] = NLH_Wiener(8,N2,N3,Ns,8,double(y_est11),double(y_est21),double(y_est31),single(gamma),...
